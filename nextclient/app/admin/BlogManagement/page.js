...
export default function BlogManagement() {
  ...
  return (
    <AdminLayout
      ...
      pageSubtitle="Edit & manage all your blog posts"
    >
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  <label style={labelStyle}>
                    Upload Image <span style={{ color: "#e53e3e" }}>*</span>
                  </label>
                  <input
                    type="file"
                    accept="image/*"
                  ...
                  {uploadingImage && (
                    ...
                    >
                      <MdCloudUpload style={{ fontSize: "16px" }} /> Uploading
                      image...
                    </div>
                  )}
                  {editFormData.image && (
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      padding: "13px",
                      background:
                        editLoading || uploadingImage ? `${gold}80` : gold,
                      border: "none",
                      borderRadius: "12px",
                      color: "#fff",
                      fontSize: "15px",
