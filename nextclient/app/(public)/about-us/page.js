 ...
 * Visual redesign: same content, same gold-accent theme — layout now leads
 * with imagery (offices, team, story) instead of stacked text/icon blocks.
 */
...
const offices = [
  { city: 'Mumbai', tag: 'Head Office', icon: FaBuilding, image: 'https://images.unsplash.com/photo-1529253355930-ddbe423a2ac7?ixlib=rb-4.0.3&auto=format&fit=crop&w=700&q=75' },
  { city: 'Hyderabad', tag: 'India', icon: FaGlobe, image: 'https://images.unsplash.com/photo-1572445271230-a78b5944a659?ixlib=rb-4.0.3&auto=format&fit=crop&w=700&q=75' },
  { city: 'Dubai', tag: 'UAE', icon: FaGlobe, image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?ixlib=rb-4.0.3&auto=format&fit=crop&w=700&q=75' },
  { city: 'San Ramon', tag: 'California, USA', icon: FaFlag, image: 'https://images.unsplash.com/photo-1449034446853-66c86144b0ad?ixlib=rb-4.0.3&auto=format&fit=crop&w=700&q=75' },
];
      ...
      <div className="mf-about">
        <style>{`
          ...
          .hero-bg-img {
            ...
            inset: 0;
            z-index: -2;
            background-image: url('https://images.unsplash.com/photo-1497215728101-856f4ea42174?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=75');
          ...
          .hero::before {
            ...
            z-index: -1;
            background:
              linear-gradient(180deg, rgba(10,10,10,0.82) 0%, rgba(10,10,10,0.68) 50%, rgba(10,10,10,0.92) 100%),
              radial-gradient(ellipse 700px 400px at 50% 0%, rgba(201, 168, 76, 0.18), transparent 65%);
            pointer-events: none;
          }
          ...
          .hero-frame-tl { top: 40px; left: 40px; border-top: 1.5px solid var(--gold-light); border-left: 1.5px solid var(--gold-light); }
          .hero-frame-br { bottom: 40px; right: 40px; border-bottom: 1.5px solid var(--gold-light); border-right: 1.5px solid var(--gold-light); }
          .hero-inner {
            position: relative;
            max-width: 780px;
            margin: 0 auto;
          ...
          .hero h1 {
            font-size: 58px; font-weight: 700; line-height: 1.06;
            margin: 0 0 20px;
            color: #fff;
          ...
          .hero p strong { color: var(--gold-light); font-weight: 600; }
          ...
          .story-visual-overlay {
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, rgba(26, 26, 26, 0.45) 0%, rgba(26, 26, 26, 0.05) 55%, rgba(26,26,26,0.55) 100%);
          }
          .story-visual-badge {
            position: absolute;
            bottom: 24px;
          ...
          .team-visual-overlay {
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, rgba(26, 26, 26, 0.35) 0%, rgba(26, 26, 26, 0.02) 60%);
          }
          .team-visual-label {
            position: absolute;
            bottom: 20px;
          ...
          .offices .section-head h2 span { color: var(--gold); }
          ...
          .office-text { position: absolute; bottom: 16px; left: 18px; right: 18px; }
          .office-city {
            font-family: 'Cormorant Garamond', serif;
            font-weight: 700;
            font-size: 21px;
          ...
          .faq-side h2 span { color: var(--gold); }
          .faq-side p {
            font-size: 15px;
            color: var(--ink-light);
            line-height: 1.8;
          ...
          .faq-side-visual img { width: 100%; height: 100%; object-fit: cover; display: block; }
          .faq-side-visual::after {
            content: '';
            position: absolute; inset: 0;
          ...
          .faq-icon.is-open { transform: rotate(45deg); background: var(--gold); color: #fff; }
          ...
          .cta-bg-img {
            position: absolute; inset: 0; z-index: -2;
            background-image: url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1800&q=75');
            background-size: cover;
            background-position: center;
          }
          .cta-section::before {
            ...
            z-index: -1;
            background:
              linear-gradient(135deg, rgba(10,10,10,0.93) 0%, rgba(20,20,20,0.9) 100%),
              radial-gradient(ellipse 600px 400px at 50% 50%, rgba(201, 168, 76, 0.12), transparent 65%);
            pointer-events: none;
          }
          .cta-section-inner {
            position: relative;
          ...
          @media (max-width: 1024px) {
            ...
            .offices .section-head { padding: 0 24px; }
            .faq-wrap { grid-template-columns: 1fr; padding: 0 24px; gap: 32px; }
          ...
          @media (max-width: 640px) {
            ...
            .offices .section-head { padding: 0 16px; }
            .office-card { height: 170px; }
        ...
        <section className="hero">
          ...
          <div className="hero-frame-tl"></div>
          <div className="hero-frame-br"></div>
        ...
        <Reveal>
          <section className="offices">
            <div className="section-head">
              ...
              <h2>Four Cities, <span>One Frame of Reference</span></h2>
              <p>
                From Andheri West to California — a bench built to run advertising and digital
                campaigns across time zones.
              </p>
            </div>
              ...
              {offices.map((o) => {
                ...
                return (
                  <div className="office-card" key={o.city}>
                    <img src={o.image} alt={`${o.city} office`} />
                    <span className="office-icon-badge">
                      <Icon size={16} />
                    </span>
          ...
          <section className="faq-section">
            <div className="faq-wrap">
              <div className="faq-side">
                ...
                <div className="faq-side-visual">
                  <img
                    src="https://images.unsplash.com/photo-1553877522-43269d4ea984?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=78"
                    alt="Mind Frame India creative planning session"
                  />
                </div>
              </div>
              <div>
