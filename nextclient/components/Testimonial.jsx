...
// Logo data with string paths
const logos = [
  { name: 'New India Assurance', image: '/assets/client-logo/clt-1.png' },
  { name: 'InFocus', image: '/assets/client-logo/clt-2.png' },
  { name: 'Pratimoksha', image: '/assets/client-logo/clt-3.png' },
  { name: 'Leadership Mavericks', image: '/assets/client-logo/clt-4.png' },
  { name: 'Lilavati Hospital', image: '/assets/client-logo/clt-5.png' },
  { name: 'Supreme Furniture', image: '/assets/client-logo/clt-6.png' },
  { name: 'Mindframe India', image: '/assets/client-logo/clt-7.png' },
  { name: 'Additional Client', image: '/assets/client-logo/clt-8.png' },
];
...
const Testimonial = () => {
  ...
  const goTo = useCallback((idx) => {
    setVisible(false);
    setTimeout(() => {
      setCurrent((idx + testimonial.length) % testimonial.length);
      setVisible(true);
    }, 300);
  }, []);
